...
class izin_kembali_ke_asrama extends CI_Controller {
  ...
  public function __construct() {
	...
	public function index() {
		...
		$data=array('title'=>'Surat Izin Pesiar','isi' =>'siswa/izin_kembali_ke_asrama');
    ...
    $this->auth->hak_akses_siswa();
		...
		if ($this->form_validation->run() === FALSE) {
			$data = array(
				'title'=>'Surat Izin Kembali ke Asrama – Default Web Programming Division',
				'isi' =>'siswa/izin_kembali_ke_asrama'
			);
			$this->load->view('siswa/layout/wrapper',$data);
		}
		else{
