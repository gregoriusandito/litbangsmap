...
class izin_meninggalkan_sekolah extends CI_Controller {
  ...
  public function __construct() {
	...
	public function index() {
		...
		$data=array('title'=>'Surat Izin Meninggalkan Sekolah','isi' =>'siswa/izin_meninggalkan_sekolah');
    ...
    $this->auth->hak_akses_siswa();
		...
		if ($this->form_validation->run() === FALSE) {
			$data = array(
				'title'=>'Surat Izin Meninggalkan Sekolah – Default Web Programming Division',
				'isi' =>'siswa/izin_meninggalkan_sekolah'
			);
			$this->load->view('siswa/layout/wrapper',$data);
		}
		else{
