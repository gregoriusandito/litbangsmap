      ...
      <div class="row">
        <div class="small-12-centered columns">
          <h3>Daftar Surat Izin Berlibur</h3>
			...
			<div class="row">
        <div class="small-12-centered columns">
          <p class="smap-dashboard-content-text">Total Surat Izin Berlibur:	<?php echo $this->surat_model->total_ib();?></p>
        </div>
      </div>
            ...
            <thead class="smap-dashboard-invoice-table-all">
              <tr class="smap-dashboard-invoice-table-all">
						    ...
						    <th class="smap-dashboard-invoice-thead-th">Kelas</th>
								...
								<th class="smap-dashboard-invoice-thead-th">Tanggal Kembali</th>
									...
									<div class="smap-footer-social-container">
										<div class="row small-collapse">
											<ul class="smap-footer-social-item-container">
												<li class="smap-footer-social-item"><a href="<?php echo base_url() ?>admin/izin_berlibur/edit/<?php echo $list['no'] ?>" title="Lihat dan Edit Data Surat"><img class="smap-footer-social-media smap-footer-facebook" src="<?php echo base_url(); ?>assets/images/act_icon/edit.png"></a></li>
												<li class="smap-footer-social-item"><a href="<?php echo base_url() ?>admin/izin_berlibur/delete/<?php echo $list['no'] ?>" title="Hapus Surat" target="_self"> <img class="smap-footer-social-media" src="<?php echo base_url(); ?>assets/images/act_icon/cross.png"></a></li>
												<li class="smap-footer-social-item"><a href="<?php echo base_url() ?>admin/izin_berlibur/cetak/<?php echo $list['no'] ?>" title="Cetak Surat" target="_blank"> <img class="smap-footer-social-media" src="<?php echo base_url(); ?>assets/images/act_icon/print.png"></a></li>
												<li class="smap-footer-social-item"><a href="<?php echo base_url() ?>admin/izin_berlibur/finish/<?php echo $list['no'] ?>" title="Surat Selesai" target="_self"> <img class="smap-footer-social-media" src="<?php echo base_url(); ?>assets/images/act_icon/finish.png"></a></li>
											</ul>
										</div>
									</div>
								</td>
