        ...
        <div class="small-12 columns smap-dashboard-side-menu-item active">
          ...
          <div class="row">
            <div class="small-12 columns no-padding smap-dashboard-side-menu-item-submenu">
              ...
              <div class="row small-collapse">
                <div class="smap-dashboard-submenu-item"><a class="smap-dashboard-side-menu-item-submenu-links active" href="<?php echo base_url(); ?>admin/izin_kembali_ke_asrama">Izin Kembali ke Asrama</a></div>
              </div>
              <div class="row small-collapse">
    ...
    <div class="small-12 columns no-padding smap-register-container">
      <div class="row">
        <div class="small-12-centered columns">
          <h3>Daftar Surat Izin Kembali ke Asrama</h3>
        </div>
      </div>
			<div class="row">
        <div class="small-12-centered columns">
          <p class="smap-dashboard-content-text">Total Surat Izin Kembali ke Asrama:	<?php echo $this->surat_model->total_ika();?></p>
        </div>
      </div>
      <div class="row smap-dashboard-row-content">
        <div class="small-12-centered columns">
          <table class="smap-stack smap-dashboard-invoice-table">
            ...
            <tbody>
              <?php foreach($izin_kembali_ke_asrama as $list) { ?>
              <tr>
						    ...
						    <td class="smap-dashboard-invoice-table-td"><?php echo $list['hari_tgl_izin']; ?></td>
								<td class="smap-dashboard-invoice-table-td"><?php echo $list['jam_1']; ?></td>
								  ...
								  <div class="smap-footer-social-container">
								    <div class="row small-collapse">
								      <ul class="smap-footer-social-item-container">
								        <li class="smap-footer-social-item"><a href="<?php echo base_url() ?>admin/izin_kembali_ke_asrama/edit/<?php echo $list['no'] ?>" title="Lihat dan Edit Data Surat"><img class="smap-footer-social-media smap-footer-facebook" src="<?php echo base_url(); ?>assets/images/act_icon/edit.png"></a></li>
								        <li class="smap-footer-social-item"><a href="<?php echo base_url() ?>admin/izin_kembali_ke_asrama/delete/<?php echo $list['no'] ?>" title="Hapus Surat" target="_self"> <img class="smap-footer-social-media" src="<?php echo base_url(); ?>assets/images/act_icon/cross.png"></a></li>
								        <li class="smap-footer-social-item"><a href="<?php echo base_url() ?>admin/izin_kembali_ke_asrama/cetak/<?php echo $list['no'] ?>" title="Cetak Surat" target="_blank"> <img class="smap-footer-social-media" src="<?php echo base_url(); ?>assets/images/act_icon/print.png"></a></li>
								        <li class="smap-footer-social-item"><a href="<?php echo base_url() ?>admin/izin_kembali_ke_asrama/finish/<?php echo $list['no'] ?>" title="Surat Selesai" target="_self"> <img class="smap-footer-social-media" src="<?php echo base_url(); ?>assets/images/act_icon/finish.png"></a></li>
								      </ul>
								    </div>
								  </div>
								</td>
