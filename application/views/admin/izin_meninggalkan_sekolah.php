        ...
        <div class="small-12 columns smap-dashboard-side-menu-item active">
          ...
          <div class="row">
            <div class="small-12 columns no-padding smap-dashboard-side-menu-item-submenu">
              ...
              <div class="row small-collapse">
								<div class="smap-dashboard-submenu-item"><a class="smap-dashboard-side-menu-item-submenu-links active" href="<?php echo base_url(); ?>admin/izin_meninggalkan_sekolah">Izin Meninggalkan Sekolah</a></div>
              </div>
              <div class="row small-collapse">
    ...
    <div class="small-12 columns no-padding smap-register-container">
      <div class="row">
        <div class="small-12-centered columns">
          <h3>Daftar Surat Izin Meninggalkan Sekolah</h3>
        </div>
      </div>
			<div class="row">
        <div class="small-12-centered columns">
          <p class="smap-dashboard-content-text">Total Surat Izin Meninggalkan Sekolah:	<?php echo $this->surat_model->total_ims();?></p>
        </div>
      </div>
      <div class="row smap-dashboard-row-content">
        <div class="small-12-centered columns">
          <table class="smap-stack smap-dashboard-invoice-table">
            ...
            <tbody>
              <?php foreach($izin_meninggalkan_sekolah as $list) { ?>
              <tr>
								  ...
								  <div class="smap-footer-social-container">
								    <div class="row small-collapse">
								      <ul class="smap-footer-social-item-container">
								        <li class="smap-footer-social-item"><a href="<?php echo base_url() ?>admin/izin_meninggalkan_sekolah/edit/<?php echo $list['no'] ?>" title="Lihat dan Edit Data Surat"><img class="smap-footer-social-media smap-footer-facebook" src="<?php echo base_url(); ?>assets/images/act_icon/edit.png"></a></li>
								        <li class="smap-footer-social-item"><a href="<?php echo base_url() ?>admin/izin_meninggalkan_sekolah/delete/<?php echo $list['no'] ?>" title="Hapus Surat" target="_self"> <img class="smap-footer-social-media" src="<?php echo base_url(); ?>assets/images/act_icon/cross.png"></a></li>
								        <li class="smap-footer-social-item"><a href="<?php echo base_url() ?>admin/izin_meninggalkan_sekolah/cetak/<?php echo $list['no'] ?>" title="Cetak Surat" target="_blank"> <img class="smap-footer-social-media" src="<?php echo base_url(); ?>assets/images/act_icon/print.png"></a></li>
								        <li class="smap-footer-social-item"><a href="<?php echo base_url() ?>admin/izin_meninggalkan_sekolah/finish/<?php echo $list['no'] ?>" title="Surat Selesai" target="_self"> <img class="smap-footer-social-media" src="<?php echo base_url(); ?>assets/images/act_icon/finish.png"></a></li>
								      </ul>
								    </div>
								  </div>
								</td>
