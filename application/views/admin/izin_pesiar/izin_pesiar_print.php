<?php
  ...
  */
  ...
  $this->fpdf->Ln();
  $this->fpdf->Cell(19,0.5,'Hal   : Izin Pesiar',0,0,'L');
  /* tujuan surat */
  $this->fpdf->Ln(1.5);
  ...
  $this->fpdf->MultiCell(19,0.5,'            Dengan ini kami sampaikan permohonan izin pesiar untuk siswa/siswi yang tersebut di bawah ini :',0,'L');
    //tabel//
  $this->fpdf->Ln();
  $this->fpdf->SetFont('Times',"B",12);
  ...
  $this->fpdf->Output('ip_'.$detail['no_surat_1'].'/'.$detail['no_surat_2'].'/'.$detail['no_surat_3'].'/'.$detail['no_surat_4'].'/'.$detail['no_surat_5'].'.pdf',"I");
