    ...
    <div class="small-12 medium-12 columns no-padding smap-form-content-row">
      <div class="row">
        <div class="small-12-centered columns">
          <h3>Izin Tidak Mengikuti Pelajaran</h3>
        </div>
      </div>
    </div>
  </div>
	<form name="form1" method="post" action="<?php echo base_url(); ?>admin/izin_tidak_ikut_pelajaran/edit" class="myform">
  <div class="row medium-collapse smap-main-content-container">
              ...
              <div class="small-12 columns no-padding">
                <div class="row-small-collapse">
                  <div class="small-3 columns no-padding">
                    ...
                    <input class="smap-text-input" type="text"  name="no_surat_2" required value="ITIP" readonly>
                  </div>
									<div class="small-2 columns no-padding">
							...
							<div class="small-12 columns no-padding">
								<div class="row-small-collapse">
									<div class="small-4 columns no-padding">
										<input class="smap-text-input" type="text" name="jam_1" id="" value="<?php echo $detail['jam_1'] ?>">
									</div>
									<div class="small-4 columns no-padding">
										<div class="smap-menu-side-content-container"><span class="smap-menu-side-content">s/d</span></div>
									</div>
									<div class="small-4 columns no-padding">
										<input class="smap-text-input" type="text" name="jam_2" id="" value="<?php echo $detail['jam_2'] ?>">
									</div>
								</div>
							</div>
						</div>
