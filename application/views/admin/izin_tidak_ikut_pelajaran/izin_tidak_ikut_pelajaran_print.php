  ...
  */
  ...
  $this->fpdf->SetFont('Times','',12);
	...
	$this->fpdf->Ln();
	$this->fpdf->Cell(19,0.5,'Wali Kelas '.$detail['kelas'],0,0,'L');
	$this->fpdf->Ln();
	...
	$this->fpdf->MultiCell(19,0.5,'            Dengan ini kami sampaikan permohonan izin tidak mengikuti pelajaran untuk siswa/siswi yang tersebut di bawah ini :',0,'L');
    //tabel//
	$this->fpdf->Ln();
	$this->fpdf->SetFont('Times',"B",12);
  ...
  $this->fpdf->Output('itip_'.$detail['no_surat_1'].'/'.$detail['no_surat_2'].'/'.$detail['no_surat_3'].'/'.$detail['no_surat_4'].'/'.$detail['no_surat_5'].'.pdf',"I");
