    ...
    <div class="small-12 medium-12 columns no-padding smap-form-content-row">
      <div class="row">
        <div class="small-12-centered columns">
          <h3>Mengubah Data Staf Bidang Kesiswaan</h3>
        </div>
      </div>
    </div>
  </div>
  <form name="form1" method="post" action="<?php echo base_url(); ?>admin/konfig_pejabat/edit_staf_bid_kesiswaan/edit" class="myform">
  <div class="row medium-collapse smap-main-content-container">
    <div class="small-12 medium-12 columns no-padding smap-register-container">
      <div class="row">
        <div class="small-12 columns smap-form-content-row smap-register-form-row">
					<div class="row small-collapse">
						<div class="small-6 columns"><span class="smap-form-content-attribute">Nama Staf Bidang Kesiswaan</span></div>
						<div class="small-6 columns">
							<div class="small-12 columns no-padding">
								<div class="row-small-collapse">
									<div class="small-12 columns no-padding">
										<input class="smap-text-input" type="text" name="staf-bid-kesiswaan">
									</div>
								</div>
							</div>
						</div>
				...
				<div class="small-12 columns smap-form-content-row smap-register-form-row">
					<div class="row small-collapse">
						<div class="small-6 columns"><span class="smap-form-content-attribute">NIP Staf Bidang Kesiswaan</span></div>
						<div class="small-6 columns">
							<div class="small-12 columns no-padding">
								<div class="row-small-collapse">
									<div class="small-12 columns no-padding">
										<input class="smap-text-input" type="text"  name="nip-staf-bid-kesiswaan">
									</div>
								</div>
							</div>
						</div>
