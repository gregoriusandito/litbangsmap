              ...
              <div class="small-12 small-centered columns no-padding">
                <div class="row smap-dashboard-panel-header">
                  <div class="small-12 medium-12 columns no-padding">
                    <h3 class="smap-dashboard-panel-header-title">Ubah Data User</h3>
                  </div>
                </div>
                <form name="form1" method="post" action="<?php echo base_url(); ?>admin/user/edit" class="myform">
                      ...
                      <div class="row small-collapse">
                        ...
                        <div class="small-8 columns">
                          <div class="small-12 columns no-padding">
                            <div class="row-small-collapse">
                              <div class="small-12 columns no-padding">
                                <input class="smap-text-input" type="text" name="username" required value="<?php echo $detail['username'] ?>">
                      ...
                      <div class="row small-collapse">
                        ...
                        <div class="small-8 columns">
                          <div class="small-12 columns no-padding">
                            <div class="row-small-collapse">
                              <div class="small-12 columns no-padding">
                                <input class="smap-text-input" type="email" name="email" required value="<?php echo $detail['email'] ?>">
                            ...
                            <div class="row-small-collapse">
                              <div class="small-12 columns no-padding">
                                <select class="smap-text-input" name="level" id="level">
                                  <option value="siswa" <?php if($detail['level']=="siswa") { echo 'selected'; } ?>>Siswa</option>
                                  <option value="ortu" <?php if($detail['level']=="ortu") { echo 'selected'; } ?>>Orang Tua</option>
                                  <option value="admin" <?php if($detail['level']=="admin") { echo 'selected'; } ?>>Administrator</option>
                                </select>
                              </div>
                            </div>
                          </div>
