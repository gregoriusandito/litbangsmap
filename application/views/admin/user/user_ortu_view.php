    ...
    <div class="small-12 columns no-padding smap-register-container">
      <div class="row">
        <div class="small-12-centered columns">
          <h3>Manajeman User Orang Tua</h3>
        </div>
      </div>
      <div class="row">
        <div class="small-12-centered columns">
          <ul class="smap-user-select-menu">
            <li class="smap-user-select-tab"><a class="smap-order-status-link" href="<?php echo base_url(); ?>admin/user">Semua</a></li>
            <li class="smap-user-select-tab"><a class="smap-order-status-link" href="<?php echo base_url(); ?>admin/user/user_siswa">Siswa</a></li>
            <li class="smap-user-select-tab"> <a class="smap-order-status-link active" href="<?php echo base_url(); ?>admin/user/user_ortu">Orang Tua</a></li>
          </ul>
        </div>
      </div>
			<div class="row">
        <div class="small-12-centered columns">
          <p class="smap-dashboard-content-text">Daftar User Orang Tua</p>
        </div>
      </div>
