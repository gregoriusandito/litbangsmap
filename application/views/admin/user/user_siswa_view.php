      ...
      <div class="row">
        <div class="small-12-centered columns">
          <ul class="smap-user-select-menu">
            ...
            <li class="smap-user-select-tab"><a class="smap-order-status-link active" href="<?php echo base_url(); ?>admin/user/user_siswa">Siswa</a></li>
			...
			<div class="row">
        <div class="small-12-centered columns">
          <p class="smap-dashboard-content-text">Daftar User Siswa</p>
        </div>
      </div>
