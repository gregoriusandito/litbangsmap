          ...
          <div class="small-12 columns smap-dashboard-side-menu-item active">
            ...
            <div class="row">
              <div class="small-12 columns no-padding smap-dashboard-side-menu-item-submenu">
                ...
                <div class="row small-collapse">
                  <div class="smap-dashboard-submenu-item"><a class="smap-dashboard-side-menu-item-submenu-links active" href="<?php echo base_url(); ?>siswa/daftar_surat/daftar/izin_kembali_ke_asrama">Izin Kembali ke Asrama</a></div>
                </div>
                <div class="row small-collapse">
            ...
            <table class="smap-stack smap-dashboard-invoice-table">
              <thead class="smap-dashboard-invoice-table-all">
                <tr class="smap-dashboard-invoice-table-all">
                  <th class="smap-dashboard-invoice-thead-th">Hari/Tanggal</th>
                  <th class="smap-dashboard-invoice-thead-th">Jam</th>
                  <th class="smap-dashboard-invoice-thead-th">Kepentingan</th>
