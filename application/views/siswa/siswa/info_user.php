                   ...
                   <div class="small-12 columns smap-form-content-row smap-register-form-row">
                     <div class="row small-collapse">
                       ...
                       <div class="small-8 columns">
                         <div class="small-12 columns no-padding">
                           <div class="row-small-collapse">
                             <div class="small-12 columns no-padding"><a class="smap-dashboard-content-attribute special" onClick="window.location.href='<?php echo base_url() ?>siswa/user/edit_user/edit/<?php echo $list['no_user'] ?>';">Ubah Kata Sandi</a></div>
                           </div>
                         </div>
                       </div>
                     </div>
